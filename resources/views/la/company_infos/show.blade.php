...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $company_info->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Company_Infos", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/company_infos/'.$company_info->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Company_Infos", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.company_infos.destroy', $company_info->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/company_infos') }}" data-toggle="tooltip" data-placement="right" title="Back to Company Infos"><i class="fa fa-chevron-left"></i></a></li>
